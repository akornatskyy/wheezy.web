...
class MakoTemplateTestCase(unittest.TestCase):
    ...
    def test_render(self):
        ...
        gt.assert_called_once_with("signin.html")
        gt.return_value.render.assert_called_once_with(user="john")
...
class MakoCacheImplTestCase(unittest.TestCase):
    ...
    def test_not_implemented(self):
        ...
        self.assertRaises(NotImplementedError, lambda: self.cache.get("key"))
        self.assertRaises(
            NotImplementedError, lambda: self.cache.invalidate("key")
        )
    ...
    def test_get_or_create_missing_in_cache(self):
        ...
        assert "html" == self.cache.get_or_create(
            "key", mock_creation_function, namespace="namespace", time="100"
        )
        self.mock_cache.get.assert_called_once_with("prefix-key", "namespace")
...
class TenjinTemplateTestCase(unittest.TestCase):
    ...
    def test_render(self):
        ...
        mock_render.assert_called_once_with(
            "signin.html", {"user": "john"}, template.helpers
        )
...
class Jinja2TemplateTestCase(unittest.TestCase):
    ...
    def test_render(self):
        ...
        mock_render.assert_called_once_with({"user": "john"})
